...
entry:
  ...
  call void @intrinsic_add_constraint(i128 %mul4.mod, i128 %mul4.mod)
  ...
  call void @intrinsic_add_constraint(i128 %mul7.mod, i128 %mul7.mod)
  %mul8 = mul i128 %mul.mod, %mul4.mod
  %mul8.mod = srem i128 %mul8, 12539295309507511577697735
  call void @intrinsic_add_constraint(i128 %mul8.mod, i128 %mul8.mod)
  ...
  call void @intrinsic_add_constraint(i128 %mul14.mod, i128 %add15.mod)
  ...
  call void @intrinsic_add_constraint(i128 %mul23.mod, i128 %sub26.mod)

...
entry:
  ...
  call void @intrinsic_add_constraint(i128 %mul.mod, i128 %add18.mod, i1* @constraint)
  ...
  call void @intrinsic_add_constraint(i128 %mul23.mod, i128 %out25, i1* @constraint.1)
  br label %exit

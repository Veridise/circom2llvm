; ModuleID = './auditing/circom-pairing/bls12_381_func.ll'
...
entry:
  ...
  %borrow3 = call i128 @fn_intrinsic_utils_init()
  %X4 = call i128 @fn_intrinsic_utils_init()
  %carry6 = call i128 @fn_intrinsic_utils_init()
...
entry:
  ...
  %i212 = call i128 @fn_intrinsic_utils_init()
  %uniform_array = alloca [256 x [256 x i128]], align 8
  br label %loop.body

loop.body:                                        ; preds = %loop.latch20, %entry
  %i.0 = phi i128 [ 0, %entry ], [ %add22, %loop.latch20 ]
...
loop.latch20:                                     ; preds = %loop.exit
  %add22 = add i128 %i.0, 1
  %mul24 = mul i128 2, %1
  %sub25 = sub i128 %mul24, 1
  %slt26 = icmp slt i128 %add22, %sub25
  br i1 %slt26, label %loop.body, label %loop.exit27

loop.exit27:                                      ; preds = %loop.latch20
  br label %loop.body28

loop.body28:                                      ; preds = %loop.latch79, %loop.exit27
  %i19.0 = phi i128 [ 0, %loop.exit27 ], [ %add81, %loop.latch79 ]
  br label %loop.body29

loop.body29:                                      ; preds = %loop.latch72, %loop.body28
  %i2.0 = phi i128 [ 0, %loop.body28 ], [ %add74, %loop.latch72 ]
  br label %loop.body30

loop.body30:                                      ; preds = %loop.latch65, %loop.body29
  %j1.0 = phi i128 [ 0, %loop.body29 ], [ %add67, %loop.latch65 ]
  br label %loop.body31

loop.body31:                                      ; preds = %loop.latch58, %loop.body30
  %j27.0 = phi i128 [ 0, %loop.body30 ], [ %add60, %loop.latch58 ]
  %add35 = add i128 %j1.0, %j27.0
  %add38 = add i128 %i19.0, %i2.0
  %array_getter = getelementptr inbounds [256 x [256 x i128]], [256 x [256 x i128]]* %uniform_array, i128 0, i128 %add35, i128 %add38
  %prod_val39 = load i128, i128* %array_getter, align 4
  %array_getter42 = getelementptr inbounds [256 x [256 x i128]], [256 x [256 x i128]]* %3, i128 0, i128 %j1.0, i128 %i19.0
  %a43 = load i128, i128* %array_getter42, align 4
  %array_getter46 = getelementptr inbounds [256 x [256 x i128]], [256 x [256 x i128]]* %4, i128 0, i128 %j27.0, i128 %i2.0
  %b47 = load i128, i128* %array_getter46, align 4
  %mul48 = mul i128 %a43, %b47
  %add49 = add i128 %prod_val39, %mul48
  %add53 = add i128 %j1.0, %j27.0
  %add56 = add i128 %i19.0, %i2.0
  %prod_val57 = getelementptr inbounds [256 x [256 x i128]], [256 x [256 x i128]]* %uniform_array, i128 0, i128 %add53, i128 %add56
  store i128 %add49, i128* %prod_val57, align 4
  br label %loop.latch58

loop.latch58:                                     ; preds = %loop.body31
  %add60 = add i128 %j27.0, 1
  %slt63 = icmp slt i128 %add60, %2
  br i1 %slt63, label %loop.body31, label %loop.exit64

loop.exit64:                                      ; preds = %loop.latch58
  br label %loop.latch65

loop.latch65:                                     ; preds = %loop.exit64
  %add67 = add i128 %j1.0, 1
  %slt70 = icmp slt i128 %add67, %2
  br i1 %slt70, label %loop.body30, label %loop.exit71

loop.exit71:                                      ; preds = %loop.latch65
  br label %loop.latch72

loop.latch72:                                     ; preds = %loop.exit71
  %add74 = add i128 %i2.0, 1
  %slt77 = icmp slt i128 %add74, %1
  br i1 %slt77, label %loop.body29, label %loop.exit78

loop.exit78:                                      ; preds = %loop.latch72
  br label %loop.latch79

loop.latch79:                                     ; preds = %loop.exit78
  %add81 = add i128 %i19.0, 1
  %slt84 = icmp slt i128 %add81, %1
  br i1 %slt84, label %loop.body28, label %loop.exit85

loop.exit85:                                      ; preds = %loop.latch79
  %uniform_array86 = alloca [256 x [256 x i128]], align 8
  %uniform_array87 = alloca [256 x [256 x [256 x i128]]], align 8
  br label %loop.body88

loop.body88:                                      ; preds = %loop.latch110, %loop.exit85
  %j.1 = phi i128 [ 0, %loop.exit85 ], [ %add112, %loop.latch110 ]
  br label %loop.body89

loop.body89:                                      ; preds = %loop.latch101, %loop.body88
  %i.1 = phi i128 [ 0, %loop.body88 ], [ %add103, %loop.latch101 ]
  %array_getter93 = getelementptr inbounds [256 x [256 x i128]], [256 x [256 x i128]]* %uniform_array, i128 0, i128 %j.1, i128 %i.1
  %prod_val94 = load i128, i128* %array_getter93, align 4
  %call = call [256 x i128]* @SplitThreeFn(i128 %prod_val94, i128 %0, i128 %0, i128 %0)
  %split100 = getelementptr inbounds [256 x [256 x [256 x i128]]], [256 x [256 x [256 x i128]]]* %uniform_array87, i128 0, i128 %j.1, i128 %i.1
  %5 = bitcast [256 x i128]* %split100 to i8*
...
loop.latch101:                                    ; preds = %loop.body89
...
loop.body121:                                     ; preds = %loop.latch259, %loop.exit118
  %j.2 = phi i128 [ 0, %loop.exit118 ], [ %add261, %loop.latch259 ]
  ...
  %array_getter127 = getelementptr inbounds [256 x [256 x [256 x i128]]], [256 x [256 x [256 x i128]]]* %uniform_array87, i128 0, i128 %j.2, i128 0, i128 0
  %split128 = load i128, i128* %array_getter127, align 4
  %out131 = getelementptr inbounds [256 x [256 x i128]], [256 x [256 x i128]]* %uniform_array86, i128 0, i128 %j.2, i128 0
...
if.true:                                          ; preds = %loop.body121
  %array_getter137 = getelementptr inbounds [256 x [256 x [256 x i128]]], [256 x [256 x [256 x i128]]]* %uniform_array87, i128 0, i128 %j.2, i128 0, i128 1
  %split138 = load i128, i128* %array_getter137, align 4
  %array_getter142 = getelementptr inbounds [256 x [256 x [256 x i128]]], [256 x [256 x [256 x i128]]]* %uniform_array87, i128 0, i128 %j.2, i128 1, i128 0
  %split143 = load i128, i128* %array_getter142, align 4
  %add144 = add i128 %split138, %split143
  %call147 = call [256 x i128]* @SplitFn(i128 %add144, i128 %0, i128 %0)
  %sumAndCarry150 = getelementptr inbounds [256 x [256 x i128]], [256 x [256 x i128]]* %uniform_array120, i128 0, i128 %j.2
  %7 = bitcast [256 x i128]* %sumAndCarry150 to i8*
  %8 = bitcast [256 x i128]* %call147 to i8*
  ...
  %array_getter153 = getelementptr inbounds [256 x [256 x i128]], [256 x [256 x i128]]* %uniform_array120, i128 0, i128 %j.2, i128 0
  %sumAndCarry154 = load i128, i128* %array_getter153, align 4
  %out157 = getelementptr inbounds [256 x [256 x i128]], [256 x [256 x i128]]* %uniform_array86, i128 0, i128 %j.2, i128 1
  store i128 %sumAndCarry154, i128* %out157, align 4
  %array_getter160 = getelementptr inbounds [256 x [256 x i128]], [256 x [256 x i128]]* %uniform_array120, i128 0, i128 %j.2, i128 1
  %sumAndCarry161 = load i128, i128* %array_getter160, align 4
  %carry164 = getelementptr inbounds [256 x [256 x i128]], [256 x [256 x i128]]* %uniform_array119, i128 0, i128 %j.2, i128 1
  store i128 %sumAndCarry161, i128* %carry164, align 4
  br label %if.exit
...
if.exit:                                          ; preds = %if.false, %if.true
  %mul168 = mul i128 2, %1
  %sub169 = sub i128 %mul168, 1
  %sgt170 = icmp sgt i128 %sub169, 2
  br i1 %sgt170, label %if.true165, label %if.false166

if.true165:                                       ; preds = %if.exit
  br label %loop.body171

if.false166:                                      ; preds = %if.exit
  br label %if.exit258

loop.body171:                                     ; preds = %loop.latch220, %if.true165
  %i.2 = phi i128 [ 2, %if.true165 ], [ %add222, %loop.latch220 ]
  %array_getter175 = getelementptr inbounds [256 x [256 x [256 x i128]]], [256 x [256 x [256 x i128]]]* %uniform_array87, i128 0, i128 %j.2, i128 %i.2, i128 0
  %split176 = load i128, i128* %array_getter175, align 4
  %sub180 = sub i128 %i.2, 1
  %array_getter181 = getelementptr inbounds [256 x [256 x [256 x i128]]], [256 x [256 x [256 x i128]]]* %uniform_array87, i128 0, i128 %j.2, i128 %sub180, i128 1
  %split182 = load i128, i128* %array_getter181, align 4
  %add183 = add i128 %split176, %split182
  %sub187 = sub i128 %i.2, 2
  %array_getter188 = getelementptr inbounds [256 x [256 x [256 x i128]]], [256 x [256 x [256 x i128]]]* %uniform_array87, i128 0, i128 %j.2, i128 %sub187, i128 2
  %split189 = load i128, i128* %array_getter188, align 4
  %add190 = add i128 %add183, %split189
  %sub194 = sub i128 %i.2, 1
  %array_getter195 = getelementptr inbounds [256 x [256 x i128]], [256 x [256 x i128]]* %uniform_array119, i128 0, i128 %j.2, i128 %sub194
  %carry196 = load i128, i128* %array_getter195, align 4
  %add197 = add i128 %add190, %carry196
  %call200 = call [256 x i128]* @SplitFn(i128 %add197, i128 %0, i128 %0)
  %sumAndCarry203 = getelementptr inbounds [256 x [256 x i128]], [256 x [256 x i128]]* %uniform_array120, i128 0, i128 %j.2
  %9 = bitcast [256 x i128]* %sumAndCarry203 to i8*
  %10 = bitcast [256 x i128]* %call200 to i8*
  ...
  %array_getter206 = getelementptr inbounds [256 x [256 x i128]], [256 x [256 x i128]]* %uniform_array120, i128 0, i128 %j.2, i128 0
  %sumAndCarry207 = load i128, i128* %array_getter206, align 4
  %out211 = getelementptr inbounds [256 x [256 x i128]], [256 x [256 x i128]]* %uniform_array86, i128 0, i128 %j.2, i128 %i.2
  store i128 %sumAndCarry207, i128* %out211, align 4
  %array_getter214 = getelementptr inbounds [256 x [256 x i128]], [256 x [256 x i128]]* %uniform_array120, i128 0, i128 %j.2, i128 1
  %sumAndCarry215 = load i128, i128* %array_getter214, align 4
  %carry219 = getelementptr inbounds [256 x [256 x i128]], [256 x [256 x i128]]* %uniform_array119, i128 0, i128 %j.2, i128 %i.2
  store i128 %sumAndCarry215, i128* %carry219, align 4
  br label %loop.latch220

loop.latch220:                                    ; preds = %loop.body171
  %add222 = add i128 %i.2, 1
  %mul225 = mul i128 2, %1
  %sub226 = sub i128 %mul225, 1
  %slt227 = icmp slt i128 %add222, %sub226
  br i1 %slt227, label %loop.body171, label %loop.exit228

loop.exit228:                                     ; preds = %loop.latch220
  %mul232 = mul i128 2, %1
  %sub233 = sub i128 %mul232, 2
  %array_getter234 = getelementptr inbounds [256 x [256 x [256 x i128]]], [256 x [256 x [256 x i128]]]* %uniform_array87, i128 0, i128 %j.2, i128 %sub233, i128 1
  %split235 = load i128, i128* %array_getter234, align 4
  %mul239 = mul i128 2, %1
  %sub240 = sub i128 %mul239, 3
  %array_getter241 = getelementptr inbounds [256 x [256 x [256 x i128]]], [256 x [256 x [256 x i128]]]* %uniform_array87, i128 0, i128 %j.2, i128 %sub240, i128 2
  %split242 = load i128, i128* %array_getter241, align 4
  %add243 = add i128 %split235, %split242
  %mul247 = mul i128 2, %1
  %sub248 = sub i128 %mul247, 2
  %array_getter249 = getelementptr inbounds [256 x [256 x i128]], [256 x [256 x i128]]* %uniform_array119, i128 0, i128 %j.2, i128 %sub248
  %carry250 = load i128, i128* %array_getter249, align 4
  %add251 = add i128 %add243, %carry250
  %mul255 = mul i128 2, %1
  %sub256 = sub i128 %mul255, 1
  %out257 = getelementptr inbounds [256 x [256 x i128]], [256 x [256 x i128]]* %uniform_array86, i128 0, i128 %j.2, i128 %sub256
  store i128 %add251, i128* %out257, align 4
  br label %if.exit258

if.exit258:                                       ; preds = %loop.exit228, %if.false166
  br label %loop.latch259

loop.latch259:                                    ; preds = %if.exit258
  %add261 = add i128 %j.2, 1
  %mul264 = mul i128 2, %2
  %sub265 = sub i128 %mul264, 1
  %slt266 = icmp slt i128 %add261, %sub265
  br i1 %slt266, label %loop.body121, label %loop.exit267

loop.exit267:                                     ; preds = %loop.latch259
  ret [256 x [256 x i128]]* %uniform_array86
}
...
entry:
  %i6 = call i128 @fn_intrinsic_utils_init()
  %isZero7 = call i128 @fn_intrinsic_utils_init()
  br label %loop.body

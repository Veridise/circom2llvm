...
entry:
  ...
  store i128 %j24, i128* %j2, align 4
...
entry:
  ...
  store i128 %a_idx4, i128* %a_idx, align 4
...
entry:
  ...
  %remainder6 = alloca [256 x i128], align 8
  store [256 x i128]* %remainder6, [256 x i128]** %remainder, align 8
...
entry:
  ...
  %x2 = alloca [256 x i128], align 8
  store [256 x i128]* %x2, [256 x i128]** %x, align 8
  ...
  %u10 = alloca [256 x i128], align 8
  store [256 x i128]* %u10, [256 x i128]** %u, align 8
  %ret = alloca [256 x i128]*, align 8
  ...
  %newv13 = alloca [256 x i128], align 8
  store [256 x i128]* %newv13, [256 x i128]** %newv, align 8
  %ka = alloca i128, align 8
  %ka14 = call i128 @fn_intrinsic_inline_init()
  store i128 %ka14, i128* %ka, align 4
...
entry:
  ...
  %out0_div3 = alloca [256 x [256 x i128]], align 8
  store [256 x [256 x i128]]* %out0_div3, [256 x [256 x i128]]** %out0_div, align 8
  ...
  %sq_sum_div9 = alloca [256 x [256 x i128]], align 8
  store [256 x [256 x i128]]* %sq_sum_div9, [256 x [256 x i128]]** %sq_sum_div, align 8

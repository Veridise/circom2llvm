...
loop.exit:                                        ; preds = %loop.latch
  ...
  call void @fn_intrinsic_add_constraint(i128 %lc128, i128 %in29, i1* @constraint.3)
  br label %exit
...
entry:
  ...
  call void @fn_intrinsic_add_constraint(i128 %out6, i128 %add, i1* @constraint.4)
...
loop.exit:                                        ; preds = %loop.latch
  ...
  call void @fn_intrinsic_add_constraint(i128 %iszero.in.read_input_outter, i128 %in30, i1* @constraint.7)
...
entry:
  ...
  call void @fn_intrinsic_add_constraint(i128 %out9, i128 %iszero.out.read_output_outter, i1* @constraint.11)
...
entry:
  ...
  call void @fn_intrinsic_add_constraint(i128 %out16, i128 %sub15, i1* @constraint.15)
...
entry:
  ...
  call void @fn_intrinsic_add_constraint(i128 %out24, i128 %lessthan.out.read_output_outter, i1* @constraint.18)
...
entry:
  ...
  store i128 %slsb8, i128* %slsb, align 4
  %i = alloca i128, align 8
...
loop.exit:                                        ; preds = %loop.latch
  ...
  call void @fn_intrinsic_add_constraint(i128 %sout141, i128 %sum140, i1* @constraint.23)
  ...
  call void @fn_intrinsic_add_constraint(i128 %num2bits.in.read_input_outter, i128 %sout145, i1* @constraint.24)
  ...
  call void @fn_intrinsic_add_constraint(i128 %out153, i128 %num2bits152, i1* @constraint.25)
...
entry:
  ...
  store i128 %lin3, i128* %lin, align 4
  %k = alloca i128, align 8
  %k4 = call i128 @fn_intrinsic_inline_init()
  store i128 %k4, i128* %k, align 4
...
loop.exit62:                                      ; preds = %loop.latch56
  ...
  call void @fn_intrinsic_add_constraint(i128 %lin63, i128 %lout64, i1* @constraint.31)
  br label %exit
...
loop.exit:                                        ; preds = %loop.latch
  ...
  call void @fn_intrinsic_add_constraint(i128 %out16, i128 %lc115, i1* @constraint.36)
...
entry:
  ...
  call void @fn_intrinsic_add_constraint(i128 %num2bits.in.read_input_outter, i128 %in, i1* @constraint.38)
  %ptr_getter = load %struct_template_circuit_num2bits*, %struct_template_circuit_num2bits** %n2b, align 8
  %num2bits.in.write_input_outter = getelementptr inbounds %struct_template_circuit_num2bits, %struct_template_circuit_num2bits* %ptr_getter, i32 0, i32 1
...
entry:
  ...
  call void @fn_intrinsic_add_constraint(i128 %out24, i128 %lessthan.out.read_output_outter, i1* @constraint.43)
...
loop.exit:                                        ; preds = %loop.latch
  ...
  call void @fn_intrinsic_add_constraint(i128 %out32, i128 %bits2num.out.read_output_outter, i1* @constraint.53)
...
entry:
  ...
  call void @fn_intrinsic_add_constraint(i128 %out24, i128 %lessthan.out.read_output_outter, i1* @constraint.56)
...
entry:
  ...
  %w7 = alloca [4096 x i128], align 8
  store [4096 x i128]* %w7, [4096 x i128]** %w, align 8
  %a = alloca i128, align 8
  %a8 = call i128 @fn_intrinsic_inline_init()
  store i128 %a8, i128* %a, align 4
  %out = alloca [4096 x i128]*, align 8
  %out9 = alloca [4096 x i128], align 8
  store [4096 x i128]* %out9, [4096 x i128]** %out, align 8
  %i = alloca i128, align 8
...
entry:
  ...
  store [4096 x %struct_template_circuit_binsum*]* %suma2, [4096 x %struct_template_circuit_binsum*]** %suma, align 8
  %sume = alloca [4096 x %struct_template_circuit_binsum*]*, align 8
  %sume3 = alloca [4096 x %struct_template_circuit_binsum*], align 8
  store [4096 x %struct_template_circuit_binsum*]* %sume3, [4096 x %struct_template_circuit_binsum*]** %sume, align 8
  ...
  store [4096 x %struct_template_circuit_sigmaplus*]* %sigmaPlus6, [4096 x %struct_template_circuit_sigmaplus*]** %sigmaPlus, align 8
  %fsum = alloca [4096 x %struct_template_circuit_binsum*]*, align 8
  %fsum7 = alloca [4096 x %struct_template_circuit_binsum*], align 8
  store [4096 x %struct_template_circuit_binsum*]* %fsum7, [4096 x %struct_template_circuit_binsum*]** %fsum, align 8
  ...
  %outCalc10 = alloca [4096 x i128], align 8
  store [4096 x i128]* %outCalc10, [4096 x i128]** %outCalc, align 8
  ...
  store [4096 x %struct_template_circuit_t1*]* %t117, [4096 x %struct_template_circuit_t1*]** %t1, align 8
  ...
  store [4096 x %struct_template_circuit_t2*]* %t220, [4096 x %struct_template_circuit_t2*]** %t2, align 8
...
entry:
  ...
  store [4096 x %struct_template_circuit_sha256compression*]* %sha256compression2, [4096 x %struct_template_circuit_sha256compression*]** %sha256compression, align 8
  %k = alloca i128, align 8
  %k3 = call i128 @fn_intrinsic_inline_init()
  store i128 %k3, i128* %k, align 4
  ...
  store i128 %nBlocks5, i128* %nBlocks, align 4
...
entry:
  ...
  store [4096 x %struct_template_circuit_num2bits*]* %byte_to_bits3, [4096 x %struct_template_circuit_num2bits*]** %byte_to_bits, align 8
  %sha256 = alloca %struct_template_circuit_sha256*, align 8
  %j = alloca i128, align 8

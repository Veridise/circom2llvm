...
entry:
  ...
  %c2 = alloca [4096 x i128], align 8
  store [4096 x i128]* %c2, [4096 x i128]** %c, align 8
...
loop.exit62:                                      ; preds = %loop.latch56
  ...
  call void @fn_intrinsic_add_constraint(i128 %lin63, i128 %lout64, i1* @constraint.9)
  br label %exit
...
loop.exit:                                        ; preds = %loop.latch
  ...
  call void @fn_intrinsic_add_constraint(i128 %out16, i128 %lc115, i1* @constraint.10)
...
entry:
  ...
  call void @fn_intrinsic_add_constraint(i128 %out6, i128 %add, i1* @constraint.11)
...
loop.exit:                                        ; preds = %loop.latch
  ...
  call void @fn_intrinsic_add_constraint(i128 %lc128, i128 %in29, i1* @constraint.14)
  br label %exit
...
loop.exit:                                        ; preds = %loop.latch
  ...
  call void @fn_intrinsic_add_constraint(i128 %iszero.in.read_input_outter, i128 %in30, i1* @constraint.16)
...
entry:
  ...
  call void @fn_intrinsic_add_constraint(i128 %out16, i128 %sub15, i1* @constraint.21)
...
loop.exit:                                        ; preds = %loop.latch
  ...
  call void @fn_intrinsic_add_constraint(i128 %sout141, i128 %sum140, i1* @constraint.28)
  ...
  call void @fn_intrinsic_add_constraint(i128 %num2bits.in.read_input_outter, i128 %sout145, i1* @constraint.29)
  ...
  call void @fn_intrinsic_add_constraint(i128 %out153, i128 %num2bits152, i1* @constraint.30)
...
entry:
  ...
  call void @fn_intrinsic_add_constraint(i128 %out24, i128 %lessthan.out.read_output_outter, i1* @constraint.42)
...
entry:
  ...
  call void @fn_intrinsic_add_constraint(i128 %out24, i128 %lessthan.out.read_output_outter, i1* @constraint.55)
...
entry:
  ...
  store [4096 x %struct_template_circuit_k*]* %ct_k5, [4096 x %struct_template_circuit_k*]** %ct_k, align 8
  %t1 = alloca [4096 x %struct_template_circuit_t1*]*, align 8
  %t16 = alloca [4096 x %struct_template_circuit_t1*], align 8
  store [4096 x %struct_template_circuit_t1*]* %t16, [4096 x %struct_template_circuit_t1*]** %t1, align 8
  %t = alloca i128, align 8
  %t7 = call i128 @fn_intrinsic_inline_init()
  store i128 %t7, i128* %t, align 4
  ...
  store [4096 x %struct_template_circuit_sigmaplus*]* %sigmaPlus8, [4096 x %struct_template_circuit_sigmaplus*]** %sigmaPlus, align 8
  ...
  store [4096 x %struct_template_circuit_binsum*]* %suma12, [4096 x %struct_template_circuit_binsum*]** %suma, align 8
  ...
  %outCalc15 = alloca [4096 x i128], align 8
  store [4096 x i128]* %outCalc15, [4096 x i128]** %outCalc, align 8
  ...
  store [4096 x %struct_template_circuit_binsum*]* %fsum21, [4096 x %struct_template_circuit_binsum*]** %fsum, align 8
...
entry:
  ...
  store i128 %bitsLastBlock2, i128* %bitsLastBlock, align 4
  %k = alloca i128, align 8
  %k3 = call i128 @fn_intrinsic_inline_init()
  store i128 %k3, i128* %k, align 4
  ...
  store i128 %nBlocks4, i128* %nBlocks, align 4
  ...
  store [4096 x %struct_template_circuit_sha256compression*]* %sha256compression7, [4096 x %struct_template_circuit_sha256compression*]** %sha256compression, align 8
...
loop.exit:                                        ; preds = %loop.latch
  ...
  call void @fn_intrinsic_add_constraint(i128 %out32, i128 %bits2num.out.read_output_outter, i1* @constraint.165)
...
entry:
  ...
  call void @fn_intrinsic_add_constraint(i128 %num2bits.in.read_input_outter, i128 %in, i1* @constraint.166)
  %ptr_getter = load %struct_template_circuit_num2bits*, %struct_template_circuit_num2bits** %n2b, align 8
  %num2bits.in.write_input_outter = getelementptr inbounds %struct_template_circuit_num2bits, %struct_template_circuit_num2bits* %ptr_getter, i32 0, i32 1
